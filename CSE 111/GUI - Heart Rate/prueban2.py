...
def morse_main_frame(frm_main):
    ...
    #Encode
    encode_btn = tk.Button(frm_main, text="Encode", font="times 16", fg="#008080", command=lambda: encode_morse(msge_code.get('1.0', tk.END), morse_code_dict()))
        ...
        try:
            ...
            for letter in text:
                ...
                if letter in morse_dict:
                    ...
                    # encode += " "
                    alert_lbl.config(text="Sorry, word not identify or not in dictionary")
