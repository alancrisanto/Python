...
def print_death_age(people_dict):
    ...
    for key, value in people_dict.items():
         ...
         print(f"{person_name} died at {death_age}")
...
def count_genders(people_dict):
    ...
    for key, value in people_dict.items():
        ...
        male = value[GENDER_INDEX].count("M")
        total_m += male

        female = value[GENDER_INDEX].count("F")
        total_f += female

    print(f"There is {total_m} mens and {total_f} women in the dictionary")
...
def print_marriages(marriages_dict, people_dict):
    ...
    for key, value in marriages_dict.items():
        ...
        # hsb_name = people_dict[husband_key][NAME_INDEX] This Also Works
        # print(hsb_name)
